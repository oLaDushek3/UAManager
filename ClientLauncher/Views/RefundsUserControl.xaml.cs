        ...
        try
        {
            ...
            var patterns = new Dictionary<string, string>()
            {
                ...
                },
                {
                    ...
                    Convert.ToInt32(selectedRefund.RefundProducts.Sum(sp => sp.Quantity))
                        .ToWords(new CultureInfo("ru-RU"))
                },
                ...
                {
                    "provider_and_signature",
                    selectedRefund.Employee.FullName + string.Join("", Enumerable.Repeat("_", 10))
                },
                {
                    "comeback_sum",
                    selectedRefund.RefundProducts.Sum(sp => sp.Amount).ToString(CultureInfo.CurrentCulture)
                },
                {
                    ...
                    Convert.ToInt32(selectedRefund.RefundProducts.Sum(sp => sp.Amount))
                        .ToWords(new CultureInfo("ru-RU"))
                },
            ...
            using (DocX document = DocX.Load(path))
            {
                ...
                foreach (var refundProduct in selectedRefund.RefundProducts)
                {
                    ...
                    table.Rows[count]
                        ...
                        .Append(Math
                            .Round(
                                (refundProduct.Product.Price * refundProduct.Product.Vat.Value / 100) *
                                refundProduct.Quantity, 2).ToString(new CultureInfo("ru-RU")))
                        .Font("Times New Roman")
                        .FontSize(12);
